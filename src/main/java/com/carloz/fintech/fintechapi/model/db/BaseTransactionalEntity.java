...
/**
 * The base class for every transactional entities
 *
...
public class BaseTransactionalEntity implements Serializable {
    ...
    /**
     * JPA entity event listener that set the <code>creationTime</code>
     * to the current timestamp before an instance of BaseTransactionalEntity
     * is persisted.
     */
    @PrePersist
    ...
    /**
     * Function for the equality of two BaseTransactionalEntity objects.
     * If the object is null, returns false.
     * If both objects are of the same class, and their <code>id</code> values are not null and equal, return
